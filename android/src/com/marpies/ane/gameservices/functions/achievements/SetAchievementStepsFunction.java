...
//				result.setResultCallback( this, 10, TimeUnit.SECONDS );
				mHelper.getmAchievementsClient().setStepsImmediate(achievementId, numSteps)
						.addOnCompleteListener(new OnCompleteListener<Boolean>() {
							...
							public void onComplete(@NonNull Task<Boolean> task) {
								...
								{
									AIR.log( "Failed to set achievement steps: " + task.getException().toString() );
...
//			Games.Achievements.setSteps( helper.getClient(), achievementId, numSteps );
			mHelper.getmAchievementsClient().setSteps(achievementId, numSteps);
